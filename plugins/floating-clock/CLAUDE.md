...
Tests live in `tests/test_session.m` + `tests/test_levers.m` + `tests/test_holidays.m` (iter-176 split) — 82 fixtures covering
...
| `ProgressBarStyle`          | NSString     | `"dots"`                 | Menu (dots / blocks / thindots / dashes / arrows / triangles / binary / braille / hearts / stars / ribbon / diamond — 12 presets, iter-91/131)                                                                                                                           |
...
| _Quick Style_               | (action)     | n/a                      | Menu → Quick Style (Brutalist / Zen / Retro CRT / Executive / Neon / Hacker / Glacier / Midnight / Featherlight / Industrial / Trading Floor / Scholar / Samba — 13 moods, iter-102/105/106/130/144/170) — writes a curated 10-key aesthetic bundle atomically. No pref. |
...
Sources/
  ...
  preferences/
    ...
    FloatingClockQuickStyles.{h,m}      13 Quick Style bundled moods (iter-104 extracted, iter-105/106/130/144/170 expansions)
  vendor/
