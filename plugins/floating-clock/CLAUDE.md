...
Tests live in `tests/test_session.m` + `tests/test_levers.m` — 39 fixtures covering
...
| _Quick Style_               | (action)     | n/a                      | Menu → Quick Style (Brutalist / Zen / Retro CRT / Executive / Neon / Hacker / Glacier / Midnight — 8 moods, iter-102/105/106) — writes a curated 10-key aesthetic bundle atomically. No pref. |
