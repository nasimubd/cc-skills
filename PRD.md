...
**Goal**: Migrate/rectify/prune/update/grow nested Project Memory CLAUDE.md files to support the Link Farm + Hub-and-Spoke with Progressive Disclosure pattern, enabling new Claude Code AI coding sessions to autonomously discover project structure.
